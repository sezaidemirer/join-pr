...
$headers .= "From: Join PR Bülten <{$from_email}>\r\n";
...
$admin_ok = mail($to_admin, $admin_subject_encoded, $admin_html, $headers);
...
$welcome_subject_encoded = '=?UTF-8?B?' . base64_encode($welcome_subject) . '?=';
$welcome_headers = $headers . "Reply-To: {$to_admin}\r\n";
$welcome_ok = mail($email, $welcome_subject_encoded, $welcome_html, $welcome_headers);
