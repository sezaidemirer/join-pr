...
$headers .= "From: Yeni Talep <{$from_email}>\r\n";
$headers .= "Reply-To: {$name} <{$email}>\r\n";
$headers .= "X-Mailer: PHP/" . phpversion() . "\r\n";

$admin_ok = mail($to_email, $subject_encoded, $html, $headers);
...
$customer_headers .= "From: Join PR Destek <{$from_email}>\r\n";
$customer_headers .= "Reply-To: {$to_email}\r\n";
$customer_headers .= "X-Mailer: PHP/" . phpversion() . "\r\n";

$customer_ok = mail($email, $customer_subject_encoded, $customer_html, $customer_headers);
