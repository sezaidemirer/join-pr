...
export function LoadingOverlay() {
  ...
  useEffect(() => {
    ...
    try {
      hasLoadedBefore = typeof window !== 'undefined' ? window.sessionStorage.getItem(SESSION_KEY) === 'true' : false;
    } catch (e) {
      // Safari'de private browsing modunda sessionStorage erişimi başarısız olabilir
    }
