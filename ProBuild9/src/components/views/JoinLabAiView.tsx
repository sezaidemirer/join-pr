...
// Portfolio başlıkları fonksiyon içinde locale'e göre belirlenecek

const mobileImages = [
  { src: '/ai_web_mobil1.webp', alt: 'Mobil Uygulama 1' },
  { src: '/ai_web_mobil2.webp', alt: 'Mobil Uygulama 2' },
  { src: '/ai_web_mobil3.webp', alt: 'Mobil Uygulama 3' },
  { src: '/ai_web_mobil4.webp', alt: 'Mobil Uygulama 4' },
];
...
export function JoinLabAiView() {
  ...
  // Portfolio kartları - locale'e göre
  const portfolioImages = [
    { 
      src: '/ai_web_e_ticaret.webp', 
      alt: 'E-ticaret', 
      title: locale === 'tr' ? 'E Ticaret Altyapıları' : 'E-Commerce Infrastructure' 
    },
    { 
      src: '/ai_web_sigorta_acentasi.webp', 
      alt: locale === 'tr' ? 'Sigorta Acentası' : 'Insurance Agency', 
      title: locale === 'tr' ? 'Sigorta Acenta Yazılımları' : 'Insurance Agency Software' 
    },
    { 
      src: '/ai_web_kurumsal_website.webp', 
      alt: locale === 'tr' ? 'Kurumsal Website' : 'Corporate Website', 
      title: locale === 'tr' ? 'Kurumsal Web Siteler' : 'Corporate Websites' 
    },
    { 
      src: '/ai_web_seyahat_acentasi.webp', 
      alt: locale === 'tr' ? 'Seyahat Acentası' : 'Travel Agency', 
      title: locale === 'tr' ? 'Seyahat Acentası Altyapıları' : 'Travel Agency Infrastructure' 
    },
  ];
    ...
    <div className="flex flex-col gap-16">
        ...
        <div className="relative flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex-1 md:flex md:justify-end">
            <div className="relative mx-auto mt-6 w-full max-w-[22rem] sm:max-w-[24rem] md:mt-0 md:ml-auto md:max-w-[26rem] lg:max-w-[28rem]">
              <Image
                src={`${BASE_PATH}/ai_web_banner.webp`}
      ...
      <section className="space-y-8">
        <h2 className="text-3xl font-semibold text-white md:text-4xl">
          {locale === 'tr' ? 'AI destekli Web Siteleri ve Acenta yazılımları' : 'AI-Powered Websites and Agency Software'}
        </h2>
      ...
      <section className="grid gap-8 rounded-3xl border border-white/10 bg-zinc-950/70 p-8 md:grid-cols-[1fr_1fr] md:p-10">
        <div className="relative flex items-center justify-center min-h-[500px]">
          <button
            onClick={prevMobile}
            className="absolute left-2 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm transition-colors hover:bg-white/20 md:left-4"
          ...
          <div className="relative mx-auto w-full max-w-[280px] overflow-hidden rounded-2xl">
            <div className="relative w-full" style={{ height: '500px' }}>
              <div
                ...
                style={{ 
                  width: '400%',
                  transform: `translateX(-${currentMobileIndex * 25}%)`
                }}
              >
          ...
          <button
            onClick={nextMobile}
            className="absolute right-2 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm transition-colors hover:bg-white/20 md:right-4"
