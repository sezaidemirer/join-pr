  ...
  return (
    <div className="flex flex-col gap-16">
        ...
        <div className="relative flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex-1 md:flex md:justify-end">
            <div className="relative mx-auto mt-4 w-full max-w-[24rem] sm:max-w-[27rem] md:mt-0 md:ml-auto md:max-w-[28rem] lg:max-w-[30rem]">
              <Image
                src={`${BASE_PATH}/pr_page_banner_.webp`}
                alt="Join PR Hero"
                width={640}
                height={640}
                priority
      ...
      <section className="space-y-8">
        <h2 className="text-3xl font-semibold text-white md:text-4xl">{translations.common.menu.services}</h2>
        <div className="grid gap-6 md:grid-cols-2">
          {page.services.map((service, index) => {
            ...
            if (index === 0) {
              ...
              image = `${BASE_PATH}/join_pr_kurumsal_iletisim.webp`;
            } else if (index === 1) {
              href = '/hizmetlerimiz/marka-iletisimi';
              image = `${BASE_PATH}/join_pr_marka_iletisimi.webp`;
            } else if (index === 2) {
              href = '/hizmetlerimiz/medya-iliskileri-yonetimi';
              image = `${BASE_PATH}/join_pr_medya_iliskileri.webp`;
            } else if (index === 3) {
              href = '/hizmetlerimiz/pazarlama-iletisimi';
              image = `${BASE_PATH}/join_pr_pazarlama_iletisimi.webp`;
            } else if (index === 4) {
              href = '/hizmetlerimiz/sponsorluk-iletisimi';
              image = `${BASE_PATH}/join_pr_sponsorluk_iletisimi.webp`;
            } else if (index === 5) {
              href = '/hizmetlerimiz/etkinlik-ve-proje-yonetimi';
              image = `${BASE_PATH}/join_pr_etkinlik_ve_proje_yonetimi.webp`;
            } else if (index === 6) {
              href = '/hizmetlerimiz/influencer-celebrity-marketing';
              image = `${BASE_PATH}/join_pr_influencer_marketing.webp`;
            } else if (index === 7) {
              href = '/hizmetlerimiz/celebrity-marketing';
              image = `${BASE_PATH}/join_pr_celebrity_marketing.webp`;
            }
      ...
      <section className="grid gap-8 rounded-3xl border border-white/10 bg-zinc-950/70 p-8 shadow-xl shadow-black/30 md:grid-cols-[1.1fr_0.9fr] md:p-10">
        <div className="space-y-6">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-teal-500 to-sky-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-teal-500/25 transition-all hover:-translate-y-0.5 hover:shadow-teal-500/40"
          >
            Medya Yansıma Portalı
          </Link>
        </div>
        <div className="relative flex items-center justify-center">
          ...
          <Image
            src={`${BASE_PATH}/pr_page_news.webp`}
      ...
      <section className="grid gap-8 rounded-3xl border border-white/10 bg-zinc-950/70 p-8 shadow-xl shadow-black/30 md:grid-cols-[0.9fr_1.1fr] md:p-10">
        <div className="relative flex items-center justify-center order-first md:order-none">
          ...
          <Image
            src={`${BASE_PATH}/pr_page_influencer.webp`}
