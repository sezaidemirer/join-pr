...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    try {
      ...
      // Safari'de private browsing modunda localStorage erişimi başarısız olabilir
    }
  }, []);
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      try {
        ...
        // Safari'de private browsing modunda localStorage/cookie erişimi başarısız olabilir
      }
    }
  }, [locale]);
