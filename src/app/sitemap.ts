...
const mainRoutes: RouteItem[] = [
  ...
  { path: '/tesekkurler', priority: 0.5, changefreq: 'yearly' },
  { path: '/thankyou', priority: 0.3, changefreq: 'yearly' },
  { path: '/reklam', priority: 0.8, changefreq: 'monthly' },
  { path: '/reklam/turizm-reklam-ajansi-performans-yonetimi', priority: 0.9, changefreq: 'monthly' },
  { path: '/reklam/pr-gorunurluk', priority: 0.7, changefreq: 'monthly' },
  { path: '/reklam/kreatif-produksiyon', priority: 0.7, changefreq: 'monthly' },
  { path: '/reklam/sosyal-medya-yonetimi', priority: 0.7, changefreq: 'monthly' },
  { path: '/reklam/ai-lab-web-otomasyon', priority: 0.7, changefreq: 'monthly' },
  { path: '/clinic-reklam-ajansi-performans-yonetimi', priority: 0.9, changefreq: 'monthly' },
  { path: '/vitrin-clinic-storyboard', priority: 0.5, changefreq: 'monthly' },
  { path: '/royal-saray-resort-bahrain', priority: 0.6, changefreq: 'monthly' },
  ...
  { path: '/is-birliklerimiz/marriott-dead-sea', priority: 0.6, changefreq: 'monthly' },
  { path: '/is-birliklerimiz/prontotour', priority: 0.6, changefreq: 'monthly' },
  { path: '/is-birliklerimiz/swissotel-sharm-el-sheikh', priority: 0.6, changefreq: 'monthly' },
  { path: '/is-birliklerimiz/villa-resorts-maldives', priority: 0.6, changefreq: 'monthly' },
