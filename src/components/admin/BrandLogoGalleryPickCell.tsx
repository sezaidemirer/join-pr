...
export function BrandLogoGalleryPickCell({ src, label, onPick }: Props) {
  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-center rounded-xl border border-zinc-600 bg-white p-2 transition group-hover:border-teal-500 group-hover:shadow-md">
